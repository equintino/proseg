...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_rnc_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_rnc_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['recarga'];
}
?>
...
<?php
 include_once("form_rnc_mob_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_rnc_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_rnc_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_numero_line" id="hidden_field_data_numero" style="<?php echo $sStyleHidden_numero; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_numero_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_numero_label"><span id="id_label_numero"><?php echo $this->nm_new_label['numero']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['php_cmp_required']['numero'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_abertura_line" id="hidden_field_data_abertura" style="<?php echo $sStyleHidden_abertura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_abertura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_abertura_label"><span id="id_label_abertura"><?php echo $this->nm_new_label['abertura']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_retorno_line" id="hidden_field_data_retorno" style="<?php echo $sStyleHidden_retorno; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_retorno_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_retorno_label"><span id="id_label_retorno"><?php echo $this->nm_new_label['retorno']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipoacao_line" id="hidden_field_data_tipoacao" style="<?php echo $sStyleHidden_tipoacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipoacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipoacao_label"><span id="id_label_tipoacao"><?php echo $this->nm_new_label['tipoacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_processo_line" id="hidden_field_data_processo" style="<?php echo $sStyleHidden_processo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_processo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_processo_label"><span id="id_label_processo"><?php echo $this->nm_new_label['processo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_responsavel_line" id="hidden_field_data_responsavel" style="<?php echo $sStyleHidden_responsavel; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_responsavel_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_responsavel_label"><span id="id_label_responsavel"><?php echo $this->nm_new_label['responsavel']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_detalhamento_line" id="hidden_field_data_detalhamento" style="<?php echo $sStyleHidden_detalhamento; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_detalhamento_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_detalhamento_label"><span id="id_label_detalhamento"><?php echo $this->nm_new_label['detalhamento']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_causas_line" id="hidden_field_data_causas" style="<?php echo $sStyleHidden_causas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_causas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_causas_label"><span id="id_label_causas"><?php echo $this->nm_new_label['causas']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_imediata_line" id="hidden_field_data_imediata" style="<?php echo $sStyleHidden_imediata; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imediata_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_imediata_label"><span id="id_label_imediata"><?php echo $this->nm_new_label['imediata']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_corretiva_line" id="hidden_field_data_corretiva" style="<?php echo $sStyleHidden_corretiva; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_corretiva_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_corretiva_label"><span id="id_label_corretiva"><?php echo $this->nm_new_label['corretiva']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_responsavel_implementacao_line" id="hidden_field_data_responsavel_implementacao" style="<?php echo $sStyleHidden_responsavel_implementacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_responsavel_implementacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_responsavel_implementacao_label"><span id="id_label_responsavel_implementacao"><?php echo $this->nm_new_label['responsavel_implementacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_eliminacao_line" id="hidden_field_data_eliminacao" style="<?php echo $sStyleHidden_eliminacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eliminacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_eliminacao_label"><span id="id_label_eliminacao"><?php echo $this->nm_new_label['eliminacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_eliminacao_novo_line" id="hidden_field_data_eliminacao_novo" style="<?php echo $sStyleHidden_eliminacao_novo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eliminacao_novo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_eliminacao_novo_label"><span id="id_label_eliminacao_novo"><?php echo $this->nm_new_label['eliminacao_novo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_registro_eficacia_line" id="hidden_field_data_registro_eficacia" style="<?php echo $sStyleHidden_registro_eficacia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_registro_eficacia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_registro_eficacia_label"><span id="id_label_registro_eficacia"><?php echo $this->nm_new_label['registro_eficacia']; ?></span></span><br>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_eficaz_line" id="hidden_field_data_eficaz" style="<?php echo $sStyleHidden_eficaz; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eficaz_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_eficaz_label"><span id="id_label_eficaz"><?php echo $this->nm_new_label['eficaz']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_eficaz_data_line" id="hidden_field_data_eficaz_data" style="<?php echo $sStyleHidden_eficaz_data; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_eficaz_data_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_eficaz_data_label"><span id="id_label_eficaz_data"><?php echo $this->nm_new_label['eficaz_data']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_novo_rnc_line" id="hidden_field_data_novo_rnc" style="<?php echo $sStyleHidden_novo_rnc; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_novo_rnc_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_novo_rnc_label"><span id="id_label_novo_rnc"><?php echo $this->nm_new_label['novo_rnc']; ?></span></span><br>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['masterValue']))
{
?>
if (parent && parent.scAjaxDetailValue)
{
<?php
foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_rnc_mob']['masterValue'] as $cmp_master => $val_master)
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_rnc_mob");
 parent.scAjaxDetailHeight("form_rnc_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
